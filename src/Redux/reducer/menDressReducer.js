...
import { FETCH_DRESS_REQUEST, FETCH_DRESS_SUCCESS, FETCH_DRESS_FAILURE, SORT_DRESS_ASC, SORT_DRESS_DESC } from "../action/menDress";

export const menDressReducer = (state = { isLoading: false, isError: false, dress: [] }, action) => {
  switch (action.type) {
