...
export const MenDressDetail = () => {
    ...
    useEffect(() => {
        fetch(`https://swanky-carpal-work.glitch.me/mendress/?id=${userId}`)
            ...
            <Box p={30}>
                <Flex>
                    ...
                    <Box w="50%" bg="#fafafa" p={50}>
                        ...
                        <Button m="8px" bg="teal" border={selectedColor === "teal" ? "4px solid grey" : ""} borderRadius="20px" _hover={{ border: "4px solid grey" }} onClick={() => setSelectedColor("Teal")}></Button> <span>Teal</span>
